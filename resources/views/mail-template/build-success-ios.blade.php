...
<p style="color: black;text-align: justify">
    We are excited to inform you that the development of your iOS app, <b>{{$details['app_name']}}</b>, is now complete! 🎉
</p>

<p style="color: black;text-align: justify">
    On your <b>“App Store”</b>, you will now find your iOS app. To publish the app, please submit it for review. You can also distribute your app  in order to test using testflight.
</p>
